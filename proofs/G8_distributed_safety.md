...
\mathrm{Safe_{dist}}(x):=\bigwedge _{a\in A}\mathrm{Safe_{\mathnormal{a}}}(x).
Then:
\mathrm{Safe_{dist}}(x)\quad \Longleftrightarrow \quad \forall a\in A:\; \mathrm{Safe_{\mathnormal{a}}}(x).
Equivalently:
...
\mathrm{Safe_{\mathnormal{a}}}(x):=\mathrm{Inv_{\mathnormal{a}}}(x)\wedge \mathrm{NoDrift_{\mathnormal{a}}}(x)\wedge \mathrm{WF_{\mathnormal{a}}}(x).
- Distributed safety:
\mathrm{Safe_{dist}}(x):=\bigwedge _{a\in A}\mathrm{Safe_{\mathnormal{a}}}(x).
...
- G3: Safe(Canon(x)) for each agent.
...
From G3:
\mathrm{Safe_{\mathnormal{a}}}(\mathrm{Canon_{\mathnormal{a}}}(x)).
...
\neg \mathrm{Safe_{\mathnormal{a}}}(x),
then:
...
\bigwedge _{a\in A}\mathrm{Safe_{\mathnormal{a}}}(x).
Thus:
\forall a\in A:\; \mathrm{Safe_{\mathnormal{a}}}(x).
□
